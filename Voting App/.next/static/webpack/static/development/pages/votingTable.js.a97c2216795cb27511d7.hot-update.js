...
/***/ "./Components/RequestVotingRow.js":
/*!****************************************!*\
  !*** ./Components/RequestVotingRow.js ***!
  \****************************************/
...
var RequestVotingRow = /*#__PURE__*/function (_Component) {
  Object(_babel_runtime_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_4__["default"])(RequestVotingRow, _Component);

  var _super = _createSuper(RequestVotingRow);

  function RequestVotingRow() {
    Object(_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_0__["default"])(this, RequestVotingRow);

    return _super.apply(this, arguments);
  }

  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(RequestVotingRow, [{
    key: "render",
    value: function render() {
      var Row = semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Table"].Row,
          Header = semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Table"].Header,
          Cell = semantic_ui_react__WEBPACK_IMPORTED_MODULE_6__["Table"].Cell;
      return __jsx(Row, null, __jsx(Cell, null, this.props.id), __jsx(Cell, {
        width: 2
      }, this.props.transaction.sA), __jsx(Cell, null, this.props.transaction.tH), __jsx(Cell, null, this.props.transaction.bN), __jsx(Cell, null, this.props.transaction.tS));
    }
  }]);
...
/* harmony default export */ __webpack_exports__["default"] = (RequestVotingRow);
...
/* harmony import */ var _Ethereum_voting__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../Ethereum/voting */ "./Ethereum/voting.js");
...
var VotingTable = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(VotingTable, [{
    ...
    value: function render() {
      ...
      return __jsx(_Components_Layout__WEBPACK_IMPORTED_MODULE_10__["default"], null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Grid"], null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Grid"].Row, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Grid"].Column, null, __jsx(_routes__WEBPACK_IMPORTED_MODULE_12__["Link"], {
        route: "/".concat(this.props.locale)
      }, __jsx("a", null, "Homepage"))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Grid"].Column, {
        floated: "right"
      }, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Button"], {
        primary: true,
        onClick: this.endEl
      }, "Logout"))), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Grid"].Row, null, __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Button"], {
        primary: true,
        floated: true,
        onClick: this.endElection
      }, "End Election"), __jsx(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Table"], {
        celled: true,
        textAlign: "center"
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_Ethereum_voting__WEBPACK_IMPORTED_MODULE_9__["default"].methods.getNumberofTransactions().call());
        ...
        case 3:
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Promise.all(Array(parseInt(numTransactions)).fill().map(function (element, index) {
            return _Ethereum_voting__WEBPACK_IMPORTED_MODULE_9__["default"].methods.transactions(index).call();
          })));
...
//# sourceMappingURL=votingTable.js.a97c2216795cb27511d7.hot-update.js.map